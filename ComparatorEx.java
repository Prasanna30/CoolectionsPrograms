...
public class ComparatorEx {
	...
	public static void main(String[] args) {
        ...
        Arr.add(new Employee(1031, "Anish", "Bangalore"));
        Arr.add(new Employee(1051, "Ralph", "Hyderabad"));
        Arr.add(new Employee(1001, "Manish", "Haryana"));
        System.out.println("Unsorted Data");
        System.out.println(Arr);
        Collections.sort(Arr, new Sortbyroll());
        System.out.println("sorted Data by roll");
        System.out.println(Arr);
